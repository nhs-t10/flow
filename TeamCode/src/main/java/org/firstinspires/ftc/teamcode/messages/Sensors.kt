...
data class DistanceMsg(val distance: Double, override val priority: Int) : Message
data class LightSensor(val lightDetected: Double, override val priority: Int) : Message
data class ColorMsg(val red: Int, val blue : Int, val green : Int, val hue: Int, val alpha: Int, override val priority: Int) : Message
